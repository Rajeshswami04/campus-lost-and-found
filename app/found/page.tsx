...
const holderOptions = ["finder", "security", "admin", "office"] as const;
            ...
            <div className="mt-8 space-y-4 text-sm text-zinc-400">
              <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
                ...
                <p className="mt-2 leading-6">
                  ...
                  verification questions only the owner would know.
                </p>
              </div>
              <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
          ...
          <section className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl shadow-black/20">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                  <label htmlFor="foundDate" className="mb-2 block text-sm font-medium">
                    Found date
                  </label>
                  <input
                    id="foundDate"
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    placeholder="Describe the item, what is  inside it, and any marks that make it easy to identify."
                    className="w-full rounded-lg border border-zinc-700 bg-zinc-800 p-3 text-white placeholder-zinc-500 outline-none transition focus:border-transparent focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={3}
                    placeholder="Example: what is serial number, what is color , it is new or old , etc."
                    className="w-full rounded-lg border border-zinc-700 bg-zinc-800 p-3 text-white placeholder-zinc-500 outline-none transition focus:border-transparent focus:ring-2 focus:ring-blue-500"
                  />
